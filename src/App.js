...
import {ButtonBase, Card, CardContent, FormControl, MenuItem, Select } from '@material-ui/core';
import './App.css';
    ...
    <div className="app">
      <div className='app__left'>
        <div className='app__header'>
          <h1 className='app__HeaderText' >Novel Covid-19 Statistics</h1>
          <FormControl>
        ...
        <div className='app__stats'>
            <ButtonBase  onClick={() => setType('cases')} className='app__info'>
              <InfoBox 
            ...
            <ButtonBase  onClick={() => setType('recovered')} className='app__info'>
              <InfoBox title='Recovered' newcases={countryInfo.todayRecovered} total={countryInfo.recovered} 
              active={type==='recovered'}
              />
            </ButtonBase>
            <ButtonBase onClick={() => setType('deaths')} className='app__info'>
              <InfoBox title='Deaths' newcases={countryInfo.todayDeaths} total={countryInfo.deaths} 
              isRed
              active={type==='deaths'}
              />
            </ButtonBase >
            <ButtonBase  className='app__info'>
              <InfoBox title='Active' newcases={countryInfo.todayCases} total={countryInfo.cases - (countryInfo.deaths + countryInfo.recovered)} 
              isRed
              />
            </ButtonBase >
        </div>
